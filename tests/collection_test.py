...
def test_node() -> None:
    ...
    key1, value1 = torch.ops._collection.sort_(key1, value1)
    key2, value2 = torch.ops._collection.sort_(key2, value2)
    ...
    key, value = torch.ops._collection.merge(key1, value1, key2, value2)
    ...
    key, value = torch.ops._collection.reduce(key, value)
    ...
    key, value = torch.ops._collection.ensure_(key, value, config)
