...
def main(*, model, embedding_dim, heads_num, feed_forward_dim, depth, sampling_count, lr, local_step, logging_psi_count, loss_name, log_path, checkpoint_path, model_path):
    logging.basicConfig(
    ...
    logging.info(
        "learn script start, embedding_dim: %d, heads_num: %d, feed_forward_dim: %d, depth: %d, sampling_count: %d, lr: %f, local_step: %d",
        embedding_dim,
        heads_num,
        feed_forward_dim,
        depth,
